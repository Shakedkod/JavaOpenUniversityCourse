...
public class Date
{
    ...
    private static final int LAST_DAY_IN_FEBRUARY_NORM = 28;
    private static final int LAST_DAY_IN_FEBRUARY_LEAP = 29;
    ...
    private boolean isDateValid(int day, int month, int year)
    {
        ...
        switch (month)
        {
            ...
            case FEBRUARY:
                if (isLeapYear(year))
                    return !(day < MIN_DAY || day > LAST_DAY_IN_FEBRUARY_LEAP);
                else
                    return !(day < MIN_DAY || day > LAST_DAY_IN_FEBRUARY_NORM);
        }
    ...
    private boolean isLastDayOfFebruary()
    {
        if (isLeapYear(_year))
            return (_month == FEBRUARY) && (_day == LAST_DAY_IN_FEBRUARY_LEAP);
        else
            return (_month == FEBRUARY) && (_day == LAST_DAY_IN_FEBRUARY_NORM);
    }
    ...
    public Date addYearsToDate(int num)
    {
        ...
        if (isLeapYear(_year) && isLastDayOfFebruary())
        {
        ...
        else if (isLeapYear(_year + num) && isLastDayOfFebruary())
        {
            result.setYear(_year + num);
            result.setDay(LAST_DAY_IN_FEBRUARY_LEAP);
        }
